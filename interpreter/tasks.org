...
- don't hardcode ProgramFiles and MSVC version in `windows-vcvarsall.bat`? use a default arch? use default Python?
...
- finish README dependencies, including macOS and build instructions
- put Python dependencies in "requirements.txt" file for reuse?
