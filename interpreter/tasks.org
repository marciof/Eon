...
- dependencies aren't very clear in the README
...
- build instructions README
  ...
  - https://news.ycombinator.com/item?id=26537805
- dev cycle watch?
  - https://github.com/watchexec/watchexec
  - watchexec -c --exts c,h 'echo -- `date`; make CCNAME=gcc; echo'
...
** TODO dynamic vs static linking? As option? 
...
** TODO build library too? only library?

- in a way that it can be "plugged" into the native build, as well as others?
- move non-JS parts to native and core, remove main entrypoint
