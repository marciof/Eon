...
# Are symbols callable? Zero argument functions?
# Prevents unifying symbols and strings?
# Need to specific calling symbol functions.
...
# It's familiar and reflects get chain usage.
